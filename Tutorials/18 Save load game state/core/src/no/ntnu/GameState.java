...
public class GameState {
    ...
    /**
     * Convert the game state to a JSON string. Note: it will be JSON-like, not
     * really a valid JSON!
     *
     * @return
     */
     ...
     *
     * @param jsonString JSON-like representation of the values, generated with
     * toJson() method
     * @return true on success, false otherwise
     */
    public boolean fromJson(String jsonString) {
        try {
            values = json.fromJson(values.getClass(), jsonString);
            return true;
        } catch (Exception ex) {
            System.out.println("Can't load game state from a broken JSON string");
            return false;
        }
    }
}
